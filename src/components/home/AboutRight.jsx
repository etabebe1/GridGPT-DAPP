...
function AboutRight() {
  ...
  return (
    <section
      ...
      style={{ width: "100vw" }}
    >
      <div className="about-container mr-3 sm:mr-10 h-full bg-gradient-to-bl from-black/60 via-black/20 to-white/5 bg-colors-quantum-silver/25 flex items-center rounded-r-lg shadow-sm sm:drop-shadow-lg border border-l-0 shadow-white/50 backdrop-blur-lg">
