...
function AboutThird() {
  ...
  return (
    <section
      ...
      style={{ width: "100vw" }}
    >
      <div className="about-container ml-3 sm:ml-10 w-full h-full bg-gradient-to-br from-white/5 via-black/20 to-black/50 bg-colors-quantum-silver/25 flex items-center">
        <div className="content max-w-[80rem] w-full flex flex-col sm:flex-row-reverse gap-5 sm:gap-10 px-3 sm:px-14 items-center justify-center">
          <div className="img-container sm:w-[50%] pr-2">
            <img src="/assets/svg/character/3.svg" alt="" className="" />
          </div>
