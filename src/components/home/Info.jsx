...
function Info() {
  ...
  return (
    <section className="info w-[90vw] my-10 mx-auto border rounded-md py-4 relative overflow-hidden">
      {/* info content */}
      <div className="info-container h-full flex flex-col justify-center gap-10">
        ...
        <div className="info-desc px-3">
          <p className="text-sm text-center text-colors-cloud-compute-white/75 max-w-xl mx-auto">
            ...
            aspernatur delectus debitis! Lorem ipsum dolor sit amet consectetur
            adipisicing elit. Fuga, vel!
          </p>
        </div>
