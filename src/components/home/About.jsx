...
function About() {
  ...
  return (
    <section
      ...
      style={{ width: "100vw" }}
    >
      <div className="about-container ml-3 sm:ml-10 w-full h-full bg-gradient-to-br from-white/10 via-black/20 to-black/50 bg-colors-quantum-silver/25 flex items-center">
